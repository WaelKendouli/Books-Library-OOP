...
#include <iomanip>
using namespace std;
class clsAddNewBooksScreen: protected clsScreen
{
	...
	static void _ReadNewBookInfo(clsBook& Book)
	{
...
public:
	static void AddNewBook()
	{
		...
		clsBook NewBook = clsBook::Find("");
		bool isExist;
		do
		{
			_ReadNewBookInfo(NewBook);
			isExist = clsBook::IsBookExist(NewBook.Name);
			if (isExist == true)
			{
